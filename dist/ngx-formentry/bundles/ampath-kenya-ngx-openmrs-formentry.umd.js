(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@ampath-kenya/ngx-openmrs-formentry', ['exports', '@angular/core', '@angular/material', '@angular/common', '@angular/forms', 'ngx-bootstrap/collapse', 'rxjs', 'moment', 'lodash', 'hammerjs', 'ngx-file-uploader', '@angular/platform-browser', 'ngx-webcam', '@angular/material/datepicker', '@angular/material/form-field', '@angular/material/core', '@angular/material-moment-adapter', '@angular/material/select', 'pdfmake/build/pdfmake.js', 'pdfmake/build/vfs_fonts.js', 'time-ago-pipe'], factory) :
    (global = global || self, factory((global['ampath-kenya'] = global['ampath-kenya'] || {}, global['ampath-kenya']['ngx-openmrs-formentry'] = {}), global.ng.core, global.ng.material, global.ng.common, global.ng.forms, global.collapse, global.rxjs, global.moment_, global.lodash, null, global.ngxFileUploader, global.ng.platformBrowser, global.ngxWebcam, global.ng.material.datepicker, global.ng.material['form-field'], global.ng.material.core, global.ng['material-moment-adapter'], global.ng.material.select, global.pdfMake, null, global.timeAgoPipe));
}(this, (function (exports, core, material, common, forms, collapse, rxjs, moment_, lodash, hammerjs, ngxFileUploader, platformBrowser, ngxWebcam, datepicker, formField, core$1, materialMomentAdapter, select, pdfMake, vfs_fonts_js, timeAgoPipe) { 'use strict';
    ...
    */
    ...
    var JsExpressionHelper = /** @class */ (function () {
        ...
        JsExpressionHelper.prototype.calcBMIForAgeZscore = function (bmiForAgeRef, height, weight) {
            ...
            var refSectionObject = lodash.first(bmiForAgeRef);
            ...
            if (refSectionObject) {
                ...
                if (bmi < minimumValue) {
                    ...
                    lodash.forEach(refObjectValues, function (value) {
                        if (value <= bmi) {
                            minReferencePoint_1.push(value);
                        }
                    });
                }
                var lastReferenceValue_1 = lodash.last(minReferencePoint_1);
                var lastValueIndex = lodash.findIndex(refObjectValues, function (o) {
        ...
        JsExpressionHelper.prototype.calcWeightForHeightZscore = function (weightForHeightRef, height, weight) {
            ...
            if (height < standardHeightMin || height > standardMaxHeight) {
                ...
                refSection = lodash.filter(weightForHeightRef, function (refObject) {
                    return parseFloat(refObject['Length']).toFixed(1) === height;
                });
            }
            var refSectionObject = lodash.first(refSection);
            if (refSectionObject) {
                var refObjectValues = Object.keys(refSectionObject).map(function (key) { return refSectionObject[key]; }).map(function (x) { return x; });
                var refObjectKeys = Object.keys(refSectionObject);
                var minimumValue = refObjectValues[1];
                ...
                var lastReferenceValue_2 = lodash.last(minReferencePoint_2);
                var lastValueIndex = lodash.findIndex(refObjectValues, function (o) {
        ...
        JsExpressionHelper.prototype.calcHeightForAgeZscore = function (heightForAgeRef, height, weight) {
            var refSectionObject = lodash.first(heightForAgeRef);
            var formattedSDValue;
            if (refSectionObject) {
                var refObjectValues = Object.keys(refSectionObject).map(function (key) { return refSectionObject[key]; }).map(function (x) { return x; });
                var refObjectKeys = Object.keys(refSectionObject);
                ...
                var lastReferenceValue_3 = lodash.last(minReferencePoint_3);
                var lastValueIndex = lodash.findIndex(refObjectValues, function (o) {
    ...
    var ValidationFactory = /** @class */ (function () {
        ...
        ValidationFactory.prototype.getValidators = function (question, form) {
            ...
            if (question.validators) {
                lodash.forEach(question.validators, function (validator) {
                ...
                if (children.hasOwnProperty(key)) {
                    ...
                    if (child instanceof GroupNode) {
                        ...
                        if (arrayNode && arrayNode.children && arrayNode.children.length > 0) {
                            lodash.forEach(arrayNode.children, function (groupNode) {
    ...
    var HistoricalFieldHelperService = /** @class */ (function () {
        ...
        HistoricalFieldHelperService.prototype.getDisplayTextFromOptions = function (question, valueProperty, displayProperty) {
            ...
            if (lodash.isArray(historicalValue.value)) {
                var valueConverted_1 = 0;
                lodash.each(historicalValue.value, function (val) {
                    lodash.each(question.options, function (option) {
    ...
    var HistoricalValueDirective = /** @class */ (function () {
        ...
        Object.defineProperty(HistoricalValueDirective.prototype, "node", {
            set: function (node) {
                if (node) {
                    this._node = node;
                    if (this._node.question.enableHistoricalValue && !lodash.isUndefined(this._node.question.historicalDataValue)) {
                        ...
                        else if (!lodash.isUndefined(this._node.question.historicalDataValue)) {
    ...
    var SelectDropdownComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('optionsList', { static: false }),
            __metadata("design:type", Object)
    ...
    var SelectComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('selection', { static: false }),
            __metadata("design:type", Object)
    ...
    var RemoteFileUploadModule = /** @class */ (function () {
        ...
        RemoteFileUploadModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, SelectModule, forms.FormsModule, SharedModule, ngxWebcam.WebcamModule, ngxFileUploader.NgxFileUploaderModule],
    ...
    var DatePickerComponent = /** @class */ (function () {
        ...
        DatePickerComponent.prototype.ngOnInit = function () {
            ...
            lodash.each(this.fullYearRange, function (v, i) {
        ...
        DatePickerComponent.prototype.generateYears = function () {
            ...
            this.fullYearRange = lodash.chunk(years, 14);
        };
        ...
        NgxDateTimePickerComponent = NgxDateTimePickerComponent_1 = __decorate([
            core.Component({
                ...
                providers: [
                    ...
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return NgxDateTimePickerComponent_1; }),
                        multi: true
                    }
                ],
        ...
        AfeNgSelectComponent = AfeNgSelectComponent_1 = __decorate([
            core.Component({
                ...
                providers: [
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return AfeNgSelectComponent_1; }),
                        multi: true
                    }
                ]
            })
    ...
    var FormSchemaCompiler = /** @class */ (function () {
        ...
        FormSchemaCompiler.prototype.findSchemaByName = function (schemaArray, nameOfSchema) {
            if (lodash.isEmpty(schemaArray) || lodash.isEmpty(nameOfSchema)) {
                return;
            }
            var foundSchema = {};
            lodash.each(schemaArray, function (schema) {
        ...
        FormSchemaCompiler.prototype.getPageInSchemaByLabel = function (schema, pageLabel) {
            if (lodash.isEmpty(schema) || lodash.isEmpty(pageLabel)) {
                return;
            }
            var foundPage = {};
            lodash.each(schema.pages, function (page) {
        ...
        FormSchemaCompiler.prototype.getSectionInSchemaByPageLabelBySectionLabel = function (schema, pageLabel, sectionLabel) {
            if (lodash.isEmpty(schema) || lodash.isEmpty(pageLabel) || lodash.isEmpty(sectionLabel)) {
                return;
            }
            var foundPage = this.getPageInSchemaByLabel(schema, pageLabel);
            if (lodash.isEmpty(foundPage)) {
                return;
            }
            var foundSection = {};
            lodash.each(foundPage.sections, function (section) {
        ...
        FormSchemaCompiler.prototype.getQuestionByIdInSchema = function (schema, questionId) {
            if (lodash.isEmpty(schema) || lodash.isEmpty(questionId)) {
                return;
            }
            if (Array.isArray(schema)) {
                var question = void 0;
                for (var i = 0; i < schema.length; i++) {
                    if (!lodash.isEmpty(schema[i])) {
        ...
        FormSchemaCompiler.prototype.getQuestionsArrayByQuestionId = function (parent, object, questionId) {
            if (Array.isArray(object)) {
                ...
                for (var i = 0; i < object.length; i++) {
                    if (!lodash.isEmpty(object[i])) {
                        returnedValue = this.getQuestionsArrayByQuestionId(object, object[i], questionId);
                    }
                    if (!lodash.isEmpty(returnedValue)) {
                        break;
                    }
                }
        ...
        FormSchemaCompiler.prototype.isSchemaSubObjectExpandable = function (object) {
            if (typeof object === 'object') {
                ...
                if (lodash.includes(objectKeys, 'pages') ||
                    lodash.includes(objectKeys, 'sections') ||
                    lodash.includes(objectKeys, 'questions')) {
                    return true;
                }
            }
            return false;
        ...
        FormSchemaCompiler.prototype.extractPlaceholderObjects = function (subSchema, objectsArray) {
            if (lodash.isEmpty(subSchema)) {
                return;
            }
            if (Array.isArray(subSchema)) {
                for (var i = 0; i < subSchema.length; i++) {
                    if (!lodash.isEmpty(subSchema[i])) {
                        this.extractPlaceholderObjects(subSchema[i], objectsArray);
                    }
                }
            }
            else if (typeof subSchema === 'object') {
                if (!lodash.isEmpty(subSchema.reference)) {
        ...
        FormSchemaCompiler.prototype.fillPlaceholderObject = function (placeHolderObject, referenceObject) {
            for (var member in referenceObject) {
                if (lodash.isEmpty(placeHolderObject[member])) {
        ...
        FormSchemaCompiler.prototype.removeExcludedQuestionsFromPlaceholder = function (placeHolder) {
            ...
            if (Array.isArray(placeHolder.reference.excludeQuestions)) {
                lodash.each(placeHolder.reference.excludeQuestions, function (excludedQuestionId) {
        ...
        FormSchemaCompiler.prototype.getReferencedObject = function (referenceData, keyValReferencedForms) {
            if (lodash.isEmpty(referenceData.form)) {
                console.error('Form compile: reference missing form attribute', referenceData);
                return;
            }
            if (lodash.isEmpty(keyValReferencedForms[referenceData.form])) {
                console.error('Form compile: referenced form alias not found', referenceData);
                return;
            }
            if (!lodash.isEmpty(referenceData.questionId)) {
                return this.getQuestionByIdInSchema(keyValReferencedForms[referenceData.form], referenceData.questionId);
            }
            if (!lodash.isEmpty(referenceData.page) && !lodash.isEmpty(referenceData.section)) {
            ...
            if (!lodash.isEmpty(referenceData.page)) {
        ...
        FormSchemaCompiler.prototype.getReferencedForms = function (formSchema, formSchemasLookupArray) {
            ...
            if (lodash.isEmpty(referencedForms)) {
                return;
            }
            var keyValReferencedForms = {};
            lodash.each(referencedForms, function (reference) {
    ...
    var HistoricalEncounterDataService = /** @class */ (function () {
        ...
        HistoricalEncounterDataService.prototype.registerEncounters = function (name, encounters) {
            ...
            if (lodash.isArray(encounters)) {
                var group_1 = [];
                lodash.each(encounters, function (encounter) {
                    group_1.push(_this._transformEncounter(encounter));
                });
                // Sort them in reverse chronological order
                encStore.data = lodash.sortBy(group_1, 'encounterDatetime').reverse();
            }
            else {
        ...
        HistoricalEncounterDataService.prototype.getAllValues = function (path, object, answers) {
            ...
            var key = path[0];
            if (lodash.isArray(object[key]) && object[key].length > 0) {
                lodash.each(object[key], function (childObject) {
        ...
        HistoricalEncounterDataService.prototype._transformEncounter = function (encounter) {
            ...
            if (encounter.obs) {
                ...
                lodash.extend(prevEncounter, processedObs);
            }
        ...
        HistoricalEncounterDataService.prototype._transformObs = function (obs) {
            ...
            var obsRep = {};
            if (lodash.isArray(obs)) {
                lodash.each(obs, function (singleObs) {
                ...
                var group_2 = {};
                lodash.each(obs.groupMembers, function (member) {
                    _this._augumentObs(group_2, _this._transformObs(member));
                });
                // Handle already existing data
                if (obsRep[obs.concept.uuid] && lodash.isArray(obsRep[obs.concept.uuid])) {
        ...
        HistoricalEncounterDataService.prototype._augumentObs = function (existing, toAdd) {
            for (var key in toAdd) {
                if (lodash.has(existing, key)) {
                    // check if not an array yet
                    if (!lodash.isArray(existing[key])) {
                        var temp = existing[key];
                        existing[key] = [temp];
                    }
                    // Check whether the incoming is array (for group members)
                    if (lodash.isArray(toAdd[key])) {
    ...
    var QuestionFactory = /** @class */ (function () {
        ...
        QuestionFactory.prototype.addValidators = function (schemaQuestion) {
            ...
            if (schemaQuestion.validators) {
                ...
                lodash.forEach(schemaQuestion.validators, function (validator) {
                    switch (validator.type) {
                        case 'date':
    ...
    var ObsAdapterHelper = /** @class */ (function () {
        ...
        ObsAdapterHelper.prototype.findObsAnswerToQuestion = function (node, obsArray) {
            ...
            if (node instanceof LeafNode ||
                ...
                lodash.each(obsArray, function (item) {
                    if (item.concept &&
            ...
            if (childQuestionsUuids.length > 0) {
                lodash.each(obsArray, function (obs) {
                    if (obs.concept &&
        ...
        ObsAdapterHelper.prototype.getChildQuestionsConceptUuids = function (node) {
            ...
            if (node.question.extras && node.question.extras.questions) {
                lodash.each(node.question.extras.questions, function (question) {
        ...
        ObsAdapterHelper.prototype.getGroupMembersConceptUuids = function (obsWithGroupMembers) {
            ...
            if (Array.isArray(obsWithGroupMembers.groupMembers)) {
                lodash.each(obsWithGroupMembers.groupMembers, function (member) {
        ...
        ObsAdapterHelper.prototype.getMultiselectObsPayload = function (node) {
            ...
            if (Array.isArray(node.initialValue)) {
                lodash.each(node.initialValue, function (item) {
            ...
            if (Array.isArray(node.control.value)) {
                lodash.each(node.control.value, function (item) {
        ...
        ObsAdapterHelper.prototype.getGroupPayload = function (node) {
            ...
            var nodeAsGroup = node;
            var childrenPayload = [];
            lodash.each(nodeAsGroup.children, function (child) {
        ...
        ObsAdapterHelper.prototype.getRepeatingGroupPayload = function (node) {
            ...
            lodash.each(nodeAsArray.children, function (child) {
                var payload = _this.getObsNodePayload(child);
                if (payload.length > 0) {
                    childrenPayload = childrenPayload.concat(payload);
                }
            ...
            if (nodeAsArray.initialValue && Array.isArray(nodeAsArray.initialValue)) {
                lodash.each(nodeAsArray.initialValue, function (obs) {
    ...
    var ObsValueAdapter = /** @class */ (function () {
            ...
            if (nodes) {
                var _loop_1 = function (node) {
                    if (node instanceof LeafNode) {
                        ...
                        var groupObs = lodash.find(payload, function (o) {
        ...
        ObsValueAdapter.prototype.setObsValue = function (node, payload) {
            if (node.question && node.question.extras &&
                ...
                node.question.extras.questionOptions.rendering !== 'checkbox' ||
                node.question.extras.questionOptions.rendering !== 'multi-select') {
                var obs = lodash.find(payload, function (o) {
                ...
                var multiObs = lodash.filter(payload, function (o) {
                    return o.concept.uuid === node.question.extras.questionOptions.concept;
                });
        ...
        ObsValueAdapter.prototype.setRepeatingGroupValues = function (node, payload) {
            var e_3, _a;
            var groupRepeatingObs = lodash.filter(payload, function (o) {
                ...
                if (found && o.groupMembers) {
                    ...
                    intersect = (lodash.intersection(obs, schemaQuestions).length > 0);
                }
        ...
        ObsValueAdapter.prototype.processGroup = function (obs, obsPayload) {
            if (obs.question && obs.question.extras && obs.question.extras.questionOptions.rendering === 'group') {
                var members = lodash.filter(this.getObsPayload(obs.groupMembers), function (o) {
                    return o.value !== '';
                });
        ...
        ObsValueAdapter.prototype.mapModelGroup = function (node, value) {
            ...
            for (var key in value) {
                if (value.hasOwnProperty(key)) {
                    var groupQuestion = lodash.find(node.question.questions, { key: key });
        ...
        ObsValueAdapter.prototype.leftOuterJoinArrays = function (first, second) {
            var unique = first.filter(function (obj) {
                return !second.some(function (obj2) {
                    return lodash.isEqual(obj.value, obj2.value);
                });
            });
            return unique;
        };
    ...
    var OrderValueAdapter = /** @class */ (function () {
        ...
        OrderValueAdapter.prototype._getExistingOrders = function (form) {
            if (form.existingOrders && form.existingOrders.orders) {
                ...
                return existingOrders = lodash.filter(existingOrders, function (order) {
    ...
    var RemoteSelectComponent = /** @class */ (function () {
        ...
        RemoteSelectComponent.prototype.search = function (value) {
            ...
            if (this.dataSource) {
                ...
                this.dataSource.searchOptions(value)
                    ...
                    if (result.length > 0) {
                        var existing = lodash.map(_this.value, lodash.clone);
                        var concat = existing.concat(result);
                        _this.items = lodash.uniqBy(concat, 'value');
                    }
                    _this.notFoundMsg = '';
                }, function (error) {
        ...
        RemoteSelectComponent.prototype.restoreSelectedValue = function (value, results) {
            var _this = this;
            var found = false;
            lodash.each(results, function (item) {
                if (item.value === value) {
                    setTimeout(function () {
        ...
        RemoteSelectComponent = RemoteSelectComponent_1 = __decorate([
            core.Component({
                ...
                providers: [
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return RemoteSelectComponent_1; }),
                        multi: true,
                    }
                ]
            }),
    ...
    var EncounterViewerService = /** @class */ (function () {
        ...
        EncounterViewerService.prototype.resolveSelectedValueFromSchema = function (answerUuid, schema) {
            ...
            var label;
            if (schema.pages) {
                lodash.forEach(schema.pages, function (page) {
            ...
            if (schema.sections) {
                lodash.forEach(schema.sections, function (section) {
            ...
            if (schema.questions) {
                lodash.forEach(schema.questions, function (question) {
                    if (question.questions) {
                        ...
                        if (question.questionOptions.answers) {
                            lodash.forEach(question.questionOptions.answers, function (answer) {
                            ...
                            lodash.forEach(question.questionOptions.selectableOrders, function (order) {
        ...
        EncounterViewerService.prototype.questionsAnswered = function (node, answered) {
            ...
            if (node.question.renderingType === 'page') {
                lodash.forEach(node.children, function (childNode) {
                ...
                lodash.forEach(node.children, function (childNode) {
                    if (childNode.question.renderingType === 'group') {
                        lodash.forEach(childNode.children, function (child) {
    ...
    var EncounterPdfViewerService = /** @class */ (function () {
        ...
        EncounterPdfViewerService.prototype.resolveValue = function (answer, form, arrayElement) {
            ...
            if (answer !== '') {
                ...
                else if (lodash.isArray(answer)) {
                    var arr_1 = [];
                    lodash.forEach(answer, function (elem) {
        ...
        EncounterPdfViewerService.prototype.displayPdf = function (form) {
            ...
            this.generatePdfDefinition(form).subscribe(function (docDefinition) {
                if (!(lodash.isEmpty(docDefinition))) {
        ...
        EncounterPdfViewerService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function EncounterPdfViewerService_Factory() { return new EncounterPdfViewerService(core.ɵɵinject(EncounterViewerService), core.ɵɵinject(ObsValueAdapter), core.ɵɵinject(DataSources)); }, token: EncounterPdfViewerService, providedIn: "root" });
    ...
    var QuestionControlComponent = /** @class */ (function () {
        ...
        QuestionControlComponent.prototype.isDate = function (str) {
            return this._dataSource.isDate(str) && !lodash.isNumber(str);
        };
        __decorate([
            core.Input(),
            __metadata("design:type", Object),
        ...
        FilePreviewComponent = FilePreviewComponent_1 = __decorate([
            core.Component({
                ...
                providers: [
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return FilePreviewComponent_1; }),
                        multi: true
                    }
                ],
                styles: [""]
        ...
        RemoteAnswerComponent = RemoteAnswerComponent_1 = __decorate([
            core.Component({
                ...
                providers: [
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return RemoteAnswerComponent_1; }),
                        multi: true
                    }
                ]
            }),
        ...
        CheckboxControlComponent = CheckboxControlComponent_1 = __decorate([
            core.Component({
                ...
                providers: [
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return CheckboxControlComponent_1; }),
                        multi: true,
                    }
                ],
                styles: ["\n    .no-border {\n      border: 0;\n      box-shadow: none;\n    }"]
...
//# sourceMappingURL=ampath-kenya-ngx-openmrs-formentry.umd.js.map

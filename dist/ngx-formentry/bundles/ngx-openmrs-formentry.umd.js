(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser/animations'), require('ngx-bootstrap/collapse'), require('hammerjs'), require('rxjs/operators'), require('@ng-select/ng-select'), require('ngx-file-uploader-ampath'), require('@angular/platform-browser'), require('@angular/material/datepicker'), require('@angular/material/form-field'), require('@angular/material'), require('@angular/material/core'), require('@angular/material-moment-adapter'), require('@angular/material/select'), require('rxjs'), require('moment'), require('lodash'), require('@angular/http'), require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('time-ago-pipe')) :
    typeof define === 'function' && define.amd ? define('ngx-openmrs-formentry', ['exports', '@angular/platform-browser/animations', 'ngx-bootstrap/collapse', 'hammerjs', 'rxjs/operators', '@ng-select/ng-select', 'ngx-file-uploader-ampath', '@angular/platform-browser', '@angular/material/datepicker', '@angular/material/form-field', '@angular/material', '@angular/material/core', '@angular/material-moment-adapter', '@angular/material/select', 'rxjs', 'moment', 'lodash', '@angular/http', '@angular/common', '@angular/core', '@angular/forms', 'time-ago-pipe'], factory) :
    (factory((global['ngx-openmrs-formentry'] = {}),global.ng.platformBrowser.animations,global.collapse,null,global.rxjs.operators,global.ngSelect,global.ngxFileUploaderAmpath,global.ng.platformBrowser,global.ng.material.datepicker,global.ng.material['form-field'],global.ng.material,global.ng.material.core,global.ng['material-moment-adapter'],global.ng.material.select,global.rxjs,global.moment_,global._,global.ng.http,global.ng.common,global.ng.core,global.ng.forms,global.timeAgoPipe));
}(this, (function (exports,animations,collapse,hammerjs,operators,ngSelect,ngxFileUploaderAmpath,platformBrowser,datepicker,formField,material,core,materialMomentAdapter,select,rxjs,moment_,_,http,common,core$1,forms,timeAgoPipe) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FormRendererComponent = /** @class */ (function () {
        function FormRendererComponent(validationFactory, dataSources, formErrorsService, document) {
            ...
            this.itemsInput$ = new rxjs.Subject();
            this.activeTab = 0;
        }
        /**
         * @return {?}
         ...
         */
            function () {
                ...
                if (this.node && this.node.question.extras &&
                    ...
                    /** @type {?} */
                    var defaltValues = rxjs.of([]);
                    if (this.dataSource.resolveSelectedValue(selectQuestion.control.value)) {
                        defaltValues = this.dataSource.resolveSelectedValue(selectQuestion.control.value).pipe(operators.catchError(function () { return rxjs.of([]); }));
                    }
                    this.items$ = rxjs.concat(defaltValues, this.itemsInput$.pipe(operators.debounceTime(200), operators.distinctUntilChanged(), operators.tap(function () { return _this.itemsLoading = true; }), operators.switchMap(function (term) {
                        return _this.dataSource.searchOptions(term).pipe(operators.catchError(function () { return rxjs.of([]); }), // empty list on error
        ...
        FormRendererComponent.propDecorators = {
            parentComponent: [{ type: core$1.Input }],
            node: [{ type: core$1.Input }],
            parentGroup: [{ type: core$1.Input }]
        };
    ...
    var HistoricalValueDirective = /** @class */ (function () {
        function HistoricalValueDirective(historicalFieldHelper) {
            ...
            this._nodeChange = new core$1.EventEmitter();
        }
        /**
         * @param {?} e
         * @return {?}
        ...
        HistoricalValueDirective.propDecorators = {
            _node: [{ type: core$1.Input }],
            _nodeChange: [{ type: core$1.Output }],
            setValue: [{ type: core$1.HostListener, args: ['click', ['$event'],] }],
            node: [{ type: core$1.Input }]
        };
    ...
    var SecurePipe = /** @class */ (function () {
         ...
         */
            function (obj) {
                ...
                this._latestReturnedValue = this._latestValue;
                return core$1.WrappedValue.wrap(this._latestValue);
            };
        /**
         * @private
         * @param {?} obj
    ...
    var SELECT_VALUE_ACCESSOR = {
        ...
        useExisting: core$1.forwardRef(function () { return SelectComponent; }),
        multi: true
    };
    var SelectComponent = /** @class */ (function () {
        function SelectComponent() {
            ...
            this.deselected = new core$1.EventEmitter();
            this.typed = new core$1.EventEmitter();
            this._value = [];
        ...
        SelectComponent.propDecorators = {
            ...
            allowClear: [{ type: core$1.Input }],
            disabled: [{ type: core$1.Input }],
            highlightColor: [{ type: core$1.Input }],
            highlightTextColor: [{ type: core$1.Input }],
            multiple: [{ type: core$1.Input }],
            noFilter: [{ type: core$1.Input }],
            notFoundMsg: [{ type: core$1.Input }],
            placeholder: [{ type: core$1.Input }],
            opened: [{ type: core$1.Output }],
            closed: [{ type: core$1.Output }],
            selected: [{ type: core$1.Output }],
            deselected: [{ type: core$1.Output }],
            typed: [{ type: core$1.Output }],
            selectionSpan: [{ type: core$1.ViewChild, args: ['selection',] }],
            dropdown: [{ type: core$1.ViewChild, args: ['dropdown',] }],
    ...
    var SelectDropdownComponent = /** @class */ (function () {
        function SelectDropdownComponent() {
            this.close = new core$1.EventEmitter();
            this.optionClicked = new core$1.EventEmitter();
            this.singleFilterClick = new core$1.EventEmitter();
            this.singleFilterInput = new core$1.EventEmitter();
            this.singleFilterKeydown = new core$1.EventEmitter();
        ...
        SelectDropdownComponent.propDecorators = {
            filterEnabled: [{ type: core$1.Input }],
            highlightColor: [{ type: core$1.Input }],
            highlightTextColor: [{ type: core$1.Input }],
            left: [{ type: core$1.Input }],
            multiple: [{ type: core$1.Input }],
            notFoundMsg: [{ type: core$1.Input }],
            optionList: [{ type: core$1.Input }],
            top: [{ type: core$1.Input }],
            width: [{ type: core$1.Input }],
            close: [{ type: core$1.Output }],
            optionClicked: [{ type: core$1.Output }],
            singleFilterClick: [{ type: core$1.Output }],
            singleFilterInput: [{ type: core$1.Output }],
            singleFilterKeydown: [{ type: core$1.Output }],
            filterInput: [{ type: core$1.ViewChild, args: ['filterInput',] }],
            optionsList: [{ type: core$1.ViewChild, args: ['optionsList',] }]
        };
        ...
        RemoteFileUploadComponent.decorators = [
            { type: core$1.Component, args: [{
                        ...
                        providers: [
                            {
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core$1.forwardRef(function () { return RemoteFileUploadComponent; }),
                                multi: true,
                            }
                        ],
    ...
    var DatePickerComponent = /** @class */ (function () {
        function DatePickerComponent() {
            ...
            this.onDatePickerCancel = new core$1.EventEmitter();
            this.onSelectDate = new core$1.EventEmitter();
        ...
        DatePickerComponent.propDecorators = {
            initDate: [{ type: core$1.Input }],
            locale: [{ type: core$1.Input }],
            viewFormat: [{ type: core$1.Input }],
            returnObject: [{ type: core$1.Input }],
            onDatePickerCancel: [{ type: core$1.Output }],
    ...
    var TimePickerComponent = /** @class */ (function () {
        function TimePickerComponent() {
            ...
            this.returnObject = 'js';
            this.onSelectTime = new core$1.EventEmitter();
            this.onTimePickerCancel = new core$1.EventEmitter();
            this.hourFormat = 'HH';
        }
        /**
         * @return {?}
        ...
        TimePickerComponent.propDecorators = {
            initTime: [{ type: core$1.Input }],
            showSecond: [{ type: core$1.Input }],
            viewFormat: [{ type: core$1.Input }],
            use12Hour: [{ type: core$1.Input }],
            returnObject: [{ type: core$1.Input }],
            onSelectTime: [{ type: core$1.Output }],
            onTimePickerCancel: [{ type: core$1.Output }]
        };
    ...
    var ModalComponent = /** @class */ (function () {
        function ModalComponent() {
            this.onOverlayClick = new core$1.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        ModalComponent.propDecorators = {
            onOverlayClick: [{ type: core$1.Output }]
        };
    ...
    var MomentPipe = /** @class */ (function () {
        ...
        MomentPipe.decorators = [
            { type: core$1.Pipe, args: [{ name: 'moment' },] }
        ];
        return MomentPipe;
    }());
    ...
    var DateTimePickerComponent = /** @class */ (function () {
        function DateTimePickerComponent() {
            ...
            this.onDateChange = new core$1.EventEmitter();
        ...
        DateTimePickerComponent.decorators = [
            { type: core$1.Component, args: [{
                        ...
                        providers: [
                            {
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core$1.forwardRef(function () { return DateTimePickerComponent; }),
                                multi: true
                            }
                        ],
        ...
        DateTimePickerComponent.propDecorators = {
            modelValue: [{ type: core$1.Input }],
            showDate: [{ type: core$1.Input }],
            showTime: [{ type: core$1.Input }],
            showWeeks: [{ type: core$1.Input }],
            weeks: [{ type: core$1.Input }],
            onDateChange: [{ type: core$1.Output }]
        };
        ...
        NgxDateTimePickerComponent.decorators = [
            { type: core$1.Component, args: [{
                        ...
                        providers: [
                            ...
                            {
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core$1.forwardRef(function () { return NgxDateTimePickerComponent; }),
                                multi: true
                            }
                        ],
        ...
        AfeNgSelectComponent.decorators = [
            { type: core$1.Component, args: [{
                        ...
                        providers: [
                            {
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core$1.forwardRef(function () { return AfeNgSelectComponent; }),
                                multi: true
                            }
                        ]
                    }] }
    ...
    var RemoteSelectComponent = /** @class */ (function () {
        function RemoteSelectComponent(renderer) {
            ...
            this.done = new core$1.EventEmitter();
            this.characters = [];
            // the method set in registerOnChange, it is just
            // a placeholder for a method that takes one parameter,
            // we use it to emit changes back to the form
        ...
        RemoteSelectComponent.decorators = [
            { type: core$1.Component, args: [{
                        ...
                        providers: [
                            {
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core$1.forwardRef(function () { return RemoteSelectComponent; }),
                                multi: true,
                            }
                        ]
                    }] }
        ...
        RemoteSelectComponent.propDecorators = {
            ...
            done: [{ type: core$1.Output }],
            selectC: [{ type: core$1.ViewChild, args: [SelectComponent,] }],
            dataSource: [{ type: core$1.Input }]
        };
    ...
    var EncounterViewerComponent = /** @class */ (function () {
        ...
        EncounterViewerComponent.propDecorators = {
            ...
            parentComponent: [{ type: core$1.Input }],
            node: [{ type: core$1.Input }],
            schema: [{ type: core$1.Input }],
            encounter: [{ type: core$1.Input }],
            form: [{ type: core$1.Input }]
        };
        ...
        FilePreviewComponent.decorators = [
            { type: core$1.Component, args: [{
                        ...
                        providers: [
                            {
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core$1.forwardRef(function () { return FilePreviewComponent; }),
                                multi: true
                            }
                        ],
                        styles: [""]
        ...
        RemoteAnswerComponent.decorators = [
            { type: core$1.Component, args: [{
                        ...
                        providers: [
                            {
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core$1.forwardRef(function () { return RemoteAnswerComponent; }),
                                multi: true
                            }
                        ]
                    }] }
        ...
        CheckboxControlComponent.decorators = [
            { type: core$1.Component, args: [{
                        ...
                        providers: [
                            {
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core$1.forwardRef(function () { return CheckboxControlComponent; }),
                                multi: true,
                            }
                        ],
                        styles: ["\n  .no-border {\n    border: 0;\n    box-shadow: none;\n  }"]
    ...
    exports.ɵd = MomentPipe;
    exports.ɵb = TimePickerComponent;
    ...
    exports.ɵf = RemoteSelectModule;
    exports.ɵk = SelectDropdownComponent;
    exports.ɵl = STYLE$1;
    exports.ɵh = SELECT_VALUE_ACCESSOR;
    exports.ɵi = SelectComponent;
    exports.ɵj = STYLE;
    exports.ɵg = SelectModule;

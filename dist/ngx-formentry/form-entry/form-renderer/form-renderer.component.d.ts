...
export declare class FormRendererComponent implements OnInit, OnDestroy {
    ...
    auto: any;
    private lastStatus;
    private lastIsTouched;
    private subs;
    constructor(validationFactory: ValidationFactory, dataSources: DataSources, formErrorsService: FormErrorsService, cd: ChangeDetectorRef, document: any);
    ngOnInit(): void;
    ngOnDestroy(): void;
